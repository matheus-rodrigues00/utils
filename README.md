...
|kebabCase|converts a string to kebab-case, splitting on camelCase boundaries and any non-alphanumeric separators|(string)|the kebab-cased string|
|snakeCase|converts a string to snake_case, splitting on camelCase boundaries and any non-alphanumeric separators|(string)|the snake_cased string|
### Phone Numbers
|Method|What It Does|Parameters|Return|
|-|-|-|-|
