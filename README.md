...
|partition|splits an array into two groups: the first with elements where the predicate is truthy, the second with the rest|(array, predicate)|tuple of [passing, failing] arrays|
